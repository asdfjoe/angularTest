...
@Component({
  selector: 'app-cde-test',
  templateUrl: './cde-test.component.html',
  styleUrls: ['./cde-test.component.scss']
})
export class CdeTestComponent {
  ...
  constructor( private cartService: CartService, private dataSourceBuilder: NbTreeGridDataSourceBuilder<FSEntry>) {
    this.dataSource = this.dataSourceBuilder.create(this.data);
  }

   ngOnInit() {
    this.cartService.getNibrsDataTest().subscribe(data => {
